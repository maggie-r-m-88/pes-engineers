        ...
        <div class="countdown overlay <?php echo esc_attr($countdown_type) ?>" style="background-image: url(<?php echo esc_url($bg_image) ?>);">
            ...
            <div class="container">
                ...
                <div class="logo">
                    ...
                    <img alt="Darna Logo" src="<?php echo esc_url($g5plus_options['light_logo']['url']) ?>" />
                ...
                <div id="opening-hours" class="opening-hours">
                    ...
                    <div class="time menu-font">
                        ...
                        <div class="count">
                            ...
                            <div class="info"><?php _e('Months','g5plus-framework') ?></div>
                        ...
                        <div class="count">
                            ...
                            <div class="info"><?php _e('Days','g5plus-framework') ?></div>
                        ...
                        <div class="count">
                            ...
                            <div class="info"><?php _e('Hours','g5plus-framework') ?></div>
                        ...
                        <div class="count">
                            ...
                            <div class="info"><?php _e('Minutes','g5plus-framework') ?></div>
                        ...
                        <div class="count">
                            ...
                            <div class="info"><?php _e('Seconds','g5plus-framework') ?></div>
