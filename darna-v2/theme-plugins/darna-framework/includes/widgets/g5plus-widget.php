				...
				case "icon":
					...
					<div style="margin: 13px 0">
						...
						<div>
							...
							<input style="float: right"  title="<?php echo __('Click to browse icon','g5plus-framework') ?>" class="browse-icon button-secondary" type="button" value="<?php echo __('Browse...','g5plus-framework') ?>" />
				...
				case "image":
					...
					<div style="margin: 13px 0">
						...
						<div class="widget-image-field">
							...
							<button style="float: right" title="<?php echo __('Click to browse image','g5plus-framework') ?>" class="browse-images button-secondary" type="button"><?php echo __('Browse...','g5plus-framework') ?></button>
