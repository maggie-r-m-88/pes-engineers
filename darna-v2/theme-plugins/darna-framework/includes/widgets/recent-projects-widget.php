...
class Darna_Recent_Portfolio extends  G5Plus_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_description = __( "Recent Portfolio", 'g5plus-framework' );


        $this->widget_id          = 'darna-recent-portfolio';


        $this->widget_name        = __( 'G5Plus: Recent Projects', 'g5plus-framework' );
        ...
        $this->settings           = array(
            ...
            'title' => array(
                ...
                'label' => __( 'Enter title ', 'g5plus-framework' ),
            ...
            'column' => array(
                ...
                'label' => __( 'Enter column ', 'g5plus-framework' ),
            ...
            'row' => array(
                ...
                'label' => __( 'Enter row ', 'g5plus-framework' ),
