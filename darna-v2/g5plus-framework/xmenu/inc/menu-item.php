	...
	<div class="xmenu-config-panel-wrapper">
		...
		<div class="xmenu-header">
			...
			<h2>
				...
				<button class="x-button xmenu-config-panel-save" type="button"><i class="fa fa-save"></i> <?php echo __('Save Changes','g5plus-framework') ?></button>
		...
		<div class="xmenu-config-panel-left">
			...
			<ul>
				...
				<li class="x-reset">
					...
					<i class="fa fa-refresh"></i> <?php _e('Reset','g5plus-framework') ?>
		...
		<div class="xmenu-icon-popup">
			...
			<div class="xmenu-icon-popup-header">
				...
				<input type="text" placeholder="<?php _e('Type to search...','g5plus-framework') ?>"/>
...
function xmenu_save_config_callback() {
	...
	$error_result = array(
		...
		'message' => __('Save menu config fail','g5plus-framework'),
