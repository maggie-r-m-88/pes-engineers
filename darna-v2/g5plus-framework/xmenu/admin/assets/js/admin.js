	...
	var XMENU = {
		...
		add_xmenu_to_wpmenu: function() {
			...
			$('ul.menu > li.menu-item').each(function(){
				...
				$('> dl > dt > span.item-title > span.menu-item-title', this).append('<span class="xmenu-item-config" data-id="' + menu_id + '"><i class="fa fa-cogs"></i> XMENU <i class="fa fa-warning"></i></span>');
