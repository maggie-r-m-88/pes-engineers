...
function tc_team_members_post_type() {
	$labels = array(
		'name' => __('Team Members', 'tc-team-members'),
		'singular_name' => __('Team Member', 'tc-team-members'),
		...
		'parent_item_colon' => '',
		'menu_name' => __('Team Members', 'tc-team-members') // this name will be shown on the menu
	);
	$args = array(
		'labels' => $labels,
		'public' => true,
