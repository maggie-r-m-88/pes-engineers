            ...
            <div class="col-md-3 portfolio-attribute">
                ...
                <div class="portfolio-info border-primary-color">
                    ...
                    <div class="portfolio-info-box">
                        ...
                        <h6 class="primary-font"><i class="fa fa-briefcase primary-color"></i><?php echo __('Architect:','g5plus-framework') ?></h6>
                    ...
                    <div class="portfolio-info-box">
                        ...
                        <h6 class="primary-font"><i class="fa fa-calendar primary-color"></i><?php echo __('Contractor:','g5plus-framework') ?></h6>


                        <div class="portfolio-term bold-color"><?php echo esc_html($portfolio_publish_date) ?></div>
                    ...
                    <div class="portfolio-info-box">
                        ...
                        <h6 class="primary-font"><i class="fa fa-money primary-color"></i><?php echo __('Completion:','g5plus-framework') ?></h6>
                    ...
                    <div class="portfolio-info-box">
                        ...
                        <h6 class="primary-font"><i class="fa fa-user primary-color"></i><?php echo __('Budget:','g5plus-framework') ?></h6>
